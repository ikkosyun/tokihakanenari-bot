...
def build_prompt(theme: SeasonTheme, stats: DayStats) -> str:
    return (
        ...
        "Centered composition, square 1:1 framing, the hourglass fills most of the frame, "
        "generous empty space in the lower area and right side of the frame for a later "
        "overlay. The photo must fill the entire square frame edge to edge with no blank, "
        "cut-off, or unfinished areas. "
